// Q10.Write a program to accept a list L1 of N integers. Accept integer D. Generate list L2 such that it contains only those integers from 
//list L1 which are divisible by D. Calculate the size of list L2. Print the list L1, N, D, list L2 and its size.
